...
Please find the datasat of the SynthRAD2023 challenge on this following link: (https://zenodo.org/records/7260705)
...
- Clone this repo:
```bash
git clone https://github.com/AlexBoving/sCT-generation-pix2pix
cd sCT-generation-pix2pix
```
